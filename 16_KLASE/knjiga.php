...
function prosecnaStranica($niz){
   $ukCena = ukupnaCena($niz);
   $ukBrStr = 0;
   foreach($niz as $stranica){
      $ukBrStr += $stranica->getBrojStrana();
   }
   return $ukCena / $ukBrStr;
}
echo "Prosečna cena stranice knjiga je " . prosecnaStranica($knjige);
echo "<hr>";
